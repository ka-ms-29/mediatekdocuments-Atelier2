...
namespace MediaTekDocuments.view
{
    ...
    {
        private readonly FrmCommandeLivreController controller;
        ...
        {
            InitializeComponent();
            this.controller = new FrmCommandeLivreController();
        }
        ...
        private void AfficheLesCommandesLivre()
        {
            ...
            lesCommandesLivre = controller.GetCommandesLivre(idDocuement);
